...
class Tensor:
    ...
    # TODO: Implement for Task 2.3. Properties: -size, -dims
    @property
    def size(self) -> int:
        """Returns
    ...
    # Functions
    # TODO: Implement for Task 2.3. Operators.
    ...
    # Should take an optional dim argument, Properties: - size - dims
    ...
    # TODO: Implement for Task 2.3. Function: zero_grad_
